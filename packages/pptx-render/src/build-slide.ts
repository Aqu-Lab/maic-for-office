...
import { tableRowGridCols } from '@maic/pptx-engine/table-grid'
import { elementDurableId, groupChildDurableId } from '@maic/pptx-engine/identity'
import { isBackgroundLikeElement } from '@maic/pptx-engine/background-promote'
