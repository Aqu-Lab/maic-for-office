 ...
 */
import type { Fill, Stroke, ShadowEffect } from '@maic/pptx-engine'
...
export function resolveGlow(
  glow: import('@maic/pptx-engine').GlowEffect | undefined,
  vp: Viewport,
...
export function resolveReflection(
  reflection: import('@maic/pptx-engine').ReflectionEffect | undefined,
  vp: Viewport,
